...
def get(tickers, startdate, enddate):
    ...
    return(pd.concat(datas,keys=tickers,names=['Ticker','Date']))
tickers=['^NSEI']
nse2 = get(tickers, datetime.datetime(2020,3,1), datetime.datetime(2020,4,1))


# In[131]:


nse2['Change']=nse2.Open - nse2.Close

nse2['Pct_Chg']=nse2.Change/nse2.Open
...
nse2['Pct_Chg'].plot(grid=True)


# In[133]:


plt.plot(nse2.Open,nse2.Volume)
